            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class=" d-flex justify-content-between align-items-center">
                        ...
                        {{-- @if ($modals->where('bulan', date('Y-m'))->count() == 0) --}}
                        ...
                        <table id="table" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle text-center table-danger">Penyusutan Karena Pajak & Biaya Bank
                                    </th>
                                    <th class="align-middle text-center table-success">Penambahan dari Alokasi Keuntungan
                                    </th>
                                    ...
                                    <th class="align-middle text-center table-warning">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="table-info">
                                ...
                                @foreach ($modals as $modal)
                                    <tr>
                                        ...
                                        <td class="align-middle text-right text-danger currency">{{ $modal->rugi }}</td>
                                        <td class="align-middle text-right text-danger currency">{{ $modal->pajak_bank }}
                                        </td>

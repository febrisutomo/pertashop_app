                            ...
                            <div class="col-8">
                                <select name="operator_id" id="operator_id"
                                    ...
                                    @foreach ($operators as $operator)
                                        <option value="{{ $operator->id }}" @selected(Auth::user()->role == 'super-admin' ? $operator->id == old('operator_id') : $operator->id == Auth::user()->id)>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="time" class="form-control @error('jam') is-invalid @enderror" id="jam"
                                    name="jam" value="{{ old('jam', date('H:i')) }}">
                                @error('jam')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="totalisator_awal" name="totalisator_awal"
                                        value="{{ old('totalisator_awal') }}" readonly>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="volume_test"
                                                        name="volume_test" value="{{ old('volume_test') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="volume_aktual"
                                                        name="volume_aktual" value="{{ old('volume_aktual') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="selisih_test"
                                                        name="selisih_test" value="{{ old('selisih_test') }}" readonly>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="volume_penjualan"
                                        name="volume_penjualan" value="{{ old('volume_penjualan') }}" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text">&ell;</span>
                                    </div>
                                </div>
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="rupiah_penjualan"
                                        id="rupiah_penjualan" value="{{ old('rupiah_penjualan') }}" readonly>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <select name="purchase_id" id="purchase_id"
                                                    ...
                                                    @foreach ($purchases as $purchase)
                                                        <option value="{{ $purchase->id }}"
                                                            ...
                                                            @selected($purchase->id == old('purchase_id'))>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="stok_sebelum_curah"
                                                        name="stok_sebelum_curah" value="{{ old('stok_sebelum_curah') }}"
                                                        readonly>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="stok_setelah_curah"
                                                        name="stok_setelah_curah" value="{{ old('stok_sebelum_curah') }}"
                                                        readonly>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="penerimaan_real"
                                                        name="penerimaan_real" value="{{ old('penerimaan_real') }}"
                                                        readonly>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">&ell;</span>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('total_pengeluaran') }}" readonly>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#operator_id, #tanggal, #jam').on('change', function() {
                ...
                let old_operator_id = "{{ old('operator_id') }}";
                @if (Auth::user()->role == 'operator')
                    old_operator_id = "{{ Auth::user()->id }}";
                @endif
                let tanggal = $('#tanggal').val();
                let jam = $('#jam').val();
                let old_price_id = "{{ old('price_id') }}";
                $.ajax({
            ...
            let last_stok_sebelum_curah = @json(old('stok_sebelum_curah'));
            ...
            let last_volume_test = @json(old('volume_test'));
            let last_volume_aktual = @json(old('volume_aktual'));
            ...
            let oldCategoryIds = @json(old('category_id', []));
            let oldJumlah = @json(old('jumlah', []));
            let oldKeterangan = @json(old('keterangan', []));

                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="stok_awal" name="stok_awal"
                                        value="{{ $stik_awal * $shop->skala }}" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text">&ell;</span>
                                    </div>
                                </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: "{{ route('daily-reports.create') }}",
                type: "GET",
                dataType: "json",
            ...
            $('#totalisator_akhir, #stik_akhir, #disetorkan').on('input', function() {
                ...
                const belum_disetorkan = {{ $belum_disetorkan }};
                $('#belum_disetorkan').val(belum_disetorkan + selisih);
            });
        })
    </script>
@endpush
